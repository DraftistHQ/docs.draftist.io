...
- **[Basics](Basics.md)** — headings, paragraphs, lists, bold, italic, strikethrough, links, etc. ^4f65e1
- **[Images](Guide/05%20-%20Providers/01%20-%20Obsidian/04%20-%20Content/02%20-%20Images/Images.md)** — images with optional placement, captions, and galleries ^070531
- **[Videos](Videos.md)** — embedded YouTube videos ^55c4ae
- **[Code](Code.md)** — syntax-highlighted code blocks with extras ^a42711
- **[Callouts](Callouts.md)** — colored boxes with optional folding, plus blockquotes ^c45623
